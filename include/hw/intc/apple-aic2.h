/*
 * Apple M1 Pro/Max (T600x) Interrupt Controller - Version 2
 * 
...
#ifndef HW_INTC_APPLE_AIC2_H
#define HW_INTC_APPLE_AIC2_H
...
#define TYPE_APPLE_AIC2 "apple-aic2"
OBJECT_DECLARE_SIMPLE_TYPE(AppleAIC2State, APPLE_AIC2)
